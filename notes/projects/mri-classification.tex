...
\begin{itemize}
    \item Diego Martinez - \url{https://github.com/Diego54523}
    \item Andrea Tirenti - \url{https://github.com/Dr-Faxzty}
    \item Emanuele Galiano - \url{https://github.com/emanuelegaliano}
\end{itemize}

\noindent
Si può trovare il codice completo del progetto al link della repository GitHub: 
\begin{center}
\url{https://github.com/Diego54523/unict-ml-year-2025-group-5-ReLU-tanti}
\end{center}
