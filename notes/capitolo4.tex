...
\begin{center}
	\textit{Ai fini di chiarezza e univocità della spiegazione, useremo $y$ per indicare ciò che fino ad ora abbiamo specificato con $\hat{y}$.}
\end{center}
...
Possiamo quindi ottenere la nostra discesa del gradiente:
$$
\vartheta_j = \vartheta_j -\alpha\frac{\partial J(\vartheta)}{\partial \vartheta_j} \qquad \forall j
$$

Calcoliamo quindi la derivata ...
...
con $p_k$ probabilità di essere di classe $k$. 
.......
