...
Anche i parametri di regolarizzazione, esattamente come il modello (i suoi parametri), devono essere stabiliti sperimentalmente. Si parte da $\lambda^0 = 0$, testando valori di  $\lambda^{i}, \lambda^{i+1}, \lambda^{i+2} \dots$ sempre più grandi, verificando come cambia $J_{\text{VAL}}(\vartheta^i)$ in funzione di $\lambda^i$. Solitamente 

$$
J_{\text{VAL}}(\vartheta^\text{best}) = \min J_{\text{VAL}}(\vartheta^i)
$$

quindi $\lambda^\text{best}$ minimizza la funzione di costo.